...
var socketPool = new _weakMap2.default();

var Command = (0, _freeze2.default)({
  GO: 0x01,
  STOP: 0x02,
  RESUME: 0x03,
  TIMED: 0x04,
...
var Message = function () {
  ...
  (0, _createClass3.default)(Message, [{
    ...
    value: function readFader(buffer) {
      ...
      this.data.position = { percent: Number((100 / 0x3fff * value).toFixed(2)), value: value };
    ...
    value: function readBuffer(buffer) {
      var _readHeader = this.readHeader(buffer),
          length = _readHeader.length,
          command = _readHeader.command;
    ...
    value: function writeFadeTime(buffer, offset, time) {
      ...
      buffer.writeUInt8((0, _trunc2.default)(hour), offset);
      buffer.writeUInt8((0, _trunc2.default)(minute), ++offset);
      buffer.writeUInt8((0, _trunc2.default)(second), ++offset);
    ...
    value: function writeFader(buffer) {
      var _data$position = this.data.position,
          _data$position$percen = _data$position.percent,
          percent = _data$position$percen === undefined ? this.data.position || 0 : _data$position$percen,
          value = _data$position.value;

      var coarse = value >= 0 ? value / 128 : percent * 1.28;
      var fine = coarse % 1 * 128;
      var exec = Number(this.data.exec || 0);

      buffer.writeUInt8(exec.toFixed(), 0x12);
      buffer.writeUInt8(exec % 1 || 1, 0x13);
      buffer.writeUInt8((0, _trunc2.default)(fine), 0x14);
      buffer.writeUInt8((0, _trunc2.default)(coarse), 0x15);
...
var Receiver = function (_EventEmitter) {
  (0, _inherits3.default)(Receiver, _EventEmitter);
  ...
  function Receiver(port, address, type) {
     ...
     */
    var _this = (0, _possibleConstructorReturn3.default)(this, (Receiver.__proto__ || (0, _getPrototypeOf2.default)(Receiver)).call(this));
    ...
    socketPool.set(_this, dgram.createSocket({
      type: type || 'udp4',
      reuseAddr: true
      ...
      try {
        ...
        if (msg.checkTarget(_this.config)) {
          (function (_ref) {
            ...
            _this.emit.apply(_this, [command].concat((0, _toConsumableArray3.default)((0, _values2.default)(data))));
          })(msg);
        }
      } catch (err) {
        _this.emit('error', err);
...
var Transmitter = function (_EventEmitter2) {
  (0, _inherits3.default)(Transmitter, _EventEmitter2);

  function Transmitter(port, address, type) {
    (0, _classCallCheck3.default)(this, Transmitter);
     ...
     */
    var _this2 = (0, _possibleConstructorReturn3.default)(this, (Transmitter.__proto__ || (0, _getPrototypeOf2.default)(Transmitter)).call(this));
    ...
    socket.sendMessage = function (command, data) {
      return socket.sendBuffer(Message.toBuffer(command, data, _this2.config));
    };

    socketPool.set(_this2, socket);
    return _this2;
  }
  ...
  (0, _createClass3.default)(Transmitter, [{
    key: 'send',
    ...
    value: function goto(cue, exec, fade) {
      return this.send('goto', { cue: cue, exec: exec, fade: fade });
    }
    ...
    value: function pause(exec) {
      return this.send('pause', { exec: exec });
    }
    ...
    value: function resume(exec) {
      return this.send('resume', { exec: exec });
    }
    ...
    value: function fader(position, exec, fade) {
      return this.send('fader', { position: position, exec: exec, fade: fade });
    }
    ...
    value: function fire(macro) {
      return this.send('fire', { macro: macro });
    }
    ...
    value: function off(exec) {
      return this.send('off', { exec: exec });
    }
  }]);
  return Transmitter;
}(EventEmitter);
